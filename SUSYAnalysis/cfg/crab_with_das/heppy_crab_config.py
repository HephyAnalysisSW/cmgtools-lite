...
taroutput = os.popen("tar czf python.tar.gz --dereference --directory $CMSSW_BASE python --exclude '*.root' --exclude '*.pdf'")
print "\n------  done tarring ...."
...
#config.Site.whitelist =  ['T2_DE_DESY', 'T2_FR_IPHC', 'T2_BE_UCL', 'T2_CH_CERN', 'T2_BR_SPRACE', 'T2_FR_IPHC', 'T2_AT_Vienna', 'T2_US_UCSD']
config.Site.whitelist =  [ 'T2_CH_CERN' , 'T2_DE_DESY', 'T2_FR_IPHC' , 'T2_AT_Vienna']
