...
##
## Bad Global Muon Tagger
##

from CMGTools.SUSYAnalysis.analyzers.badGlobalMuonAnalyzer import badGlobalMuonAnalyzer
badGlobalMuAna = cfg.Analyzer(
    badGlobalMuonAnalyzer, name="badGlobalMuonAnalyzer",
    selectClones = True,
    muonPtCut    = 3.0 ,
    )
susyCoreSequence.insert(susyCoreSequence.index(lepAna)+1, badGlobalMuAna)
