...
for sample in dataSamples_Run2016B_v3 + dataSamples_Run2016C_v1 + dataSamples_Run2016D_v1 + dataSamples_Run2016E_v1 + dataSamples_Run2016F_v1 + dataSamples_Run2016G:
    sample.json="$CMSSW_BASE/src/CMGTools/TTHAnalysis/data/json/Cert_271036-280385_13TeV_PromptReco_Collisions16_JSON.txt"
