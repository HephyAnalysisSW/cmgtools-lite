...
eventFlagsAna = cfg.Analyzer(
    ...
    triggerBits = {
        ...
        "CSCTightHaloTrkMuUnvetoFilter" : [ "Flag_CSCTightHaloTrkMuUnvetoFilter" ],
        ...
        "HcalStripHaloFilter" : [ "Flag_HcalStripHaloFilter" ],
        "hcalLaserEventFilter" : [ "Flag_hcalLaserEventFilter" ],
        "EcalDeadCellTriggerPrimitiveFilter" : [ "Flag_EcalDeadCellTriggerPrimitiveFilter" ],
        "EcalDeadCellBoundaryEnergyFilter" : [ "Flag_EcalDeadCellBoundaryEnergyFilter" ],
