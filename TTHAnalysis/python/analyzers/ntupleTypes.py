...
leptonTypeSusy = NTupleObjectType("leptonSusy", baseObjectTypes = [ leptonTypeExtra ], variables = [
    NTupleVariable("mvaIdFall17noIso",   lambda lepton : lepton.mvaRun2("Fall17noIso") if abs(lepton.pdgId()) == 11 else 1, help="EGamma POG MVA ID for non-isolated  electrons, Fall17 re-training; 1 for muons"),
    ...
    NTupleVariable("jetBTagCSV", lambda lepton : lepton.jet.btag('pfCombinedInclusiveSecondaryVertexV2BJetTags') if hasattr(lepton,'jet') and hasattr(lepton.jet, 'btag') else -4, help="CSV btag of nearest jet"),
    NTupleVariable("jetBTagCMVA", lambda lepton : lepton.jet.btag('pfCombinedMVABJetTags') if hasattr(lepton,'jet') and hasattr(lepton.jet, 'btag') else -4, help="CMA btag of nearest jet"),
    NTupleVariable("jetBTagDeepCSV", lambda lepton : (lambda x: -4 if isnan(x) else x)(lepton.jet.btag('pfDeepCSVJetTags:probb')+lepton.jet.btag('pfDeepCSVJetTags:probbb') if hasattr(lepton,'jet') and hasattr(lepton.jet, 'btag') else -4), help="DeepCSV btag of nearest jet, BvsAll = b+bb"),
    NTupleVariable("jetBTagDeepCSVCvsB", lambda lepton : (lambda x: -4 if isnan(x) else x)((lepton.jet.btag('pfDeepCSVJetTags:probc')/(lepton.jet.btag('pfDeepCSVJetTags:probc')+lepton.jet.btag('pfDeepCSVJetTags:probb')+lepton.jet.btag('pfDeepCSVJetTags:probbb'))) if hasattr(lepton,'jet') and hasattr(lepton.jet, 'btag') else -4), help="DeepCSV btag of nearest jet, CvsB = c/(c+b+bb)"),
    NTupleVariable("jetBTagDeepCSVCvsL", lambda lepton : (lambda x: -4 if isnan(x) else x)((lepton.jet.btag('pfDeepCSVJetTags:probc')/(lepton.jet.btag('pfDeepCSVJetTags:probc')+lepton.jet.btag('pfDeepCSVJetTags:probudsg'))) if hasattr(lepton,'jet') and hasattr(lepton.jet, 'btag') else -4), help="DeepCSV btag of nearest jet, CvsL = c/(c+udsg)"),
    ...
    NTupleVariable("full5x5_sigmaIetaIeta", lambda lepton: lepton.full5x5_sigmaIetaIeta() if (abs(lepton.pdgId())==11 and hasattr(lepton,"full5x5_sigmaIetaIeta")) else -1, help="Electron full5x5_sigmaIetaIeta"),
    #2016 muon Id
